...
class BannersSeeder extends Seeder
{
    public function run()
    {
        ...
        // Ensure 'home-banner' category exists or create it if it doesn't
        $homeBannerCategory = DB::table('banner_categories')->where('slug', 'home-banner')->first();

        if ($homeBannerCategory) {
            $homeBannerCategoryId = $homeBannerCategory->id;
        } else {
