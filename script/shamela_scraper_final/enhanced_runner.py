...
def extract_book_full(book_id: str, max_pages: int = None, output_dir: str = None) -> dict:
    """
...
def save_to_database(json_path: str, db_config: dict) -> dict:
    """
    ...
    try:
        result = save_enhanced_json_to_database(json_path, db_config)
