{{-- [Fix] Restored banner from last-known-good commit 2401d1b; matched structure and init logic --}}
{{-- [Safety] No changes to home tables (HTML/CSS/JS/Livewire) --}}
{{-- [Reason] Livewire re-render previously re-initialized swiper incorrectly; we isolate DOM and reinit safely --}}
...
<div class="bg-white min-h-screen">
    ...
    <section class="relative overflow-hidden">
        <div class="swiper hero-slider" wire:ignore id="home-hero-banner">
...
<script>
    ...
    // Destroy any existing instance to prevent conflicts
    if (window.HeroSwiper) {
        window.HeroSwiper.destroy(true, true);
        window.HeroSwiper = null;
    }

    // Initialize with proper scope isolation
    window.HeroSwiper = new Swiper('#home-hero-banner .hero-slider', {
        slidesPerView: 1,
        spaceBetween: 0,
