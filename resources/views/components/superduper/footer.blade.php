<!-- ===================  FOOTER  =================== -->
<footer class="bg-[#1a3a2a] text-white" dir="rtl">
    <div class="container mx-auto max-w-[1170px] px-4 py-10 flex flex-col items-center gap-10">
        ...
        @php
            ...
            ])->filter();          // يحذف القيم الفارغة مباشرة
            $faIcons = [
        ...
        {{-- حقوق النشر --}}
        <p class="text-sm text-center text-white/80 leading-relaxed">
            &copy; {{ date('Y') }}
