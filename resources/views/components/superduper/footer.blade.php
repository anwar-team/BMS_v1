            ...
            <div class="py-[60px] lg:py-20">
                <div class="container-default">
                    ...
                    <div class="grid gap-x-8 gap-y-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-[1fr_repeat(4,_auto)] xl:gap-x-10 xxl:gap-x-[134px]">
                        <div class="flex flex-col items-center gap-y-7 md:col-span-3 lg:col-span-1">
                            <a href="{{ route('home') }}">
                                @php
                            ...
                            <div>
                                <div  class="hidden lg:max-w-[416px]  ">
                                    {{ $siteSettings->description ?? '' }}
                                </div>

                                <a href="mailto:{{ $siteSettings->company_email ?? 'yourdemo@email.com' }}"
                                    class="hidden block my-6 transition-all duration-300 underline-offset-4 hover:underline">
                                    {{ $siteSettings->company_email ?? 'yourdemo@email.com' }}
                                </a>

                                <div class="hidden flex flex-wrap gap-5">
                                    @php
                                        $socialLinks = [
                        ...
                        <div class="hidden flex flex-col gap-y-7">
                        ...
                        <div class="hidden flex flex-col gap-y-6">
                            <div class="text-xl font-semibold capitalize">
                                Sample Pages
                            </div>
                            @php
