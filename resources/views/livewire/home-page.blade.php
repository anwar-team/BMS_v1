                        ...
                        <div class="px-6 py-4 flex items-center justify-between border-t border-gray-200 bg-gray-50">
                            <div class="flex items-center gap-2">
                                @if($books->hasPages())
                                    ...
                                    @else
                                        <button wire:click="previousPage('books_page')" class="p-2 rounded-full hover:bg-green-100 text-gray-600 hover:text-green-700 transition-all duration-200 transform hover:scale-110 hover:shadow-md active:scale-95">
                                    ...
                                    @if($books->hasMorePages())
                                        <button wire:click="nextPage('books_page')" class="p-2 rounded-full hover:bg-green-100 text-gray-600 hover:text-green-700 transition-all duration-200 transform hover:scale-110 hover:shadow-md active:scale-95">
                                            <svg class="w-5 h-5 transition-transform duration-200 hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="px-6 py-4 flex items-center justify-between border-t border-gray-200 bg-gray-50">
                            <div class="flex items-center gap-2">
                                @if($authors->hasPages())
                                    ...
                                    @else
                                        <button wire:click="previousPage('authors_page')" class="p-2 rounded-full hover:bg-green-100 text-gray-600 hover:text-green-700 transition-all duration-200 transform hover:scale-110 hover:shadow-md active:scale-95">
                                            <svg class="w-5 h-5 transition-transform duration-200 hover:-translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                            </svg>
                                        </button>
                                    ...
                                    @if($authors->hasMorePages())
                                        <button wire:click="nextPage('authors_page')" class="p-2 rounded-full hover:bg-green-100 text-gray-600 hover:text-green-700 transition-all duration-200 transform hover:scale-110 hover:shadow-md active:scale-95">
                                            <svg class="w-5 h-5 transition-transform duration-200 hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                                            </svg>
                                        </button>
