        ...
        <div class="relative">
            ...
            <section class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 pt-32">
                ...
                <div class="flex flex-wrap gap-4 mb-8">
                    @if($type === 'books')
                        <button wire:click="$set('type', 'books')" 
                               class="bg-white text-green-800 border border-green-800 px-5 py-2 rounded-full transition-colors duration-300 hover:bg-green-800 hover:text-white {{ $type === 'books' ? 'bg-green-800 text-white' : '' }}">
                            جميع الكتب
                        </button>
                        ...
                        @endif
                    @else
                        <button wire:click="$set('type', 'authors')" 
                                        ...
                                        <td colspan="{{ $type === 'books' ? '5' : '5' }}" class="px-6 py-12 text-center">
                                            <div class="text-gray-500">
                                                ...
                                                <p class="text-sm text-gray-500">
                                                    {{ $search ? 'جرب البحث بكلمات أخرى' : 'سيتم إضافة المحتوى قريباً' }}
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="px-6 py-4 flex items-center justify-between border-t border-gray-200 bg-gray-50">
                            ...
                            <div class="flex items-center gap-2">
                                @if($data->hasPages())
                                    ...
                                    @else
                                        <button wire:click="previousPage" class="p-2 rounded-full hover:bg-green-100 text-gray-600 hover:text-green-700 transition-all duration-200 transform hover:scale-110 hover:shadow-md active:scale-95">
                                    ...
                                    @if($data->hasMorePages())
                                        <button wire:click="nextPage" class="p-2 rounded-full hover:bg-green-100 text-gray-600 hover:text-green-700 transition-all duration-200 transform hover:scale-110 hover:shadow-md active:scale-95">
                                            <svg class="w-5 h-5 transition-transform duration-200 hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
