        ...
        return $form->schema([
            Forms\Components\Tabs::make('book_tabs')
                ->tabs([
                    ...
                    Forms\Components\Tabs\Tab::make('المجلدات والفصول')
                        ->icon('heroicon-o-folder-open')
                        ->schema([
                            Forms\Components\Section::make('المجلدات والفصول')
                                ...
                                ->collapsible(),
                    Forms\Components\Tabs\Tab::make('تفاصيل النشر')
                    ...
                    Forms\Components\Tabs\Tab::make('خصائص الكتاب')
                        ->icon('heroicon-o-book-open')
                        ->schema([
                    ...
                    Forms\Components\Tabs\Tab::make('صورة الغلاف')
